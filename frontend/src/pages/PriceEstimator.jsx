...
//   // 2. State for API Result & Loading Status
...
//         <select id="size" value={formData.size} onChange={handleChange} className="input-field">
...
//         <select id="placement" value={formData.placement} onChange={handleChange} className="input-field">
...
//         <select id="complexity" value={formData.complexity} onChange={handleChange} className="input-field">
...
//           {/* Only show pain level if your backend sends it */}
//           {result.pain_level && (
